package org.bitocean.hdgs.hive;
...
public class HiveJDBCDriver implements SQLDriver {
    ...
    private static String conStr2 = "jdbc:hive://localhost:10000/default";
    ...
    public Connection getConnection(String connectionUrl, String username, String passwd) throws SQLException {
        ...
        String conStr2 = "jdbc:hive://localhost:10000/default";
    
        if (con == null ) con = DriverManager.getConnection( conStr2 + "/edges", "", "");
        return con;
    }
