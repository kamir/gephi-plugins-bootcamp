...
import org.bitocean.hdgs.hive.HiveImportConnector; 
import org.bitocean.hdgs.mysql.MySQLImportConnector;
...
@ActionID(
        category = "File",
        id = "de.bitocean.MainAction")
@ActionRegistration(
        iconBase = "de/bitocean/treeSun16.png",
